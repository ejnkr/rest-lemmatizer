...
mod tests {
    ...
    fn it_whitespace_less() {
        assert_eq!(whitespace_less("   가     나  다 라    "), "가 나 다 라".to_string());
    }
    #[test]
    ...
    #[test]
    fn it_control_chars() {
        assert_eq!(control_chars("가힣#ㄱㅏz1()!?[]/ &", "흠"), "가힣흠ㄱㅏz1()!?[]/ 흠".to_string());
    }
    #[test]
    fn it_derepeat() {
        assert_eq!(derepeat("아아아아아 음음음 호호호호 홀홀 ", 3), "아아아 음음음 호호호 홀홀 ".to_string());
    }
    /*#[test]
